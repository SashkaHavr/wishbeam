...
export function WishlistCard({ wishlist }: Props) {
  return (
    <div className="grid grid-cols-[minmax(0,_256px)_minmax(0,_1fr)_auto] items-center gap-6 rounded-xl border bg-card px-4 py-6 text-card-foreground shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground dark:hover:bg-input/50">
