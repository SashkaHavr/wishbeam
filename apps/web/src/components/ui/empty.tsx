  ...
  "flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      variant: {
        ...
        icon: "relative flex size-9 shrink-0 items-center justify-center rounded-md border border-primary/24 bg-gradient-to-b from-primary/8 to-card text-warning-foreground shadow-sm/5 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-md)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)] [&_svg:not([class*='size-'])]:size-4.5",
      },
    },
  },
);
